...
public class QuoteService {
    ...
    public QuoteDto addQuote(Long readerId, Long bookId, QuoteDtoRequest quoteDtoRequest) {
    ...
    public QuoteDto updateQuote(Long readerId, Long bookId, Long quoteId, QuoteDtoRequest quoteDtoRequest) {
        Long authenticatedReaderId = SecurityCheck.getAuthenticatedUserId();
    ...
    public QuoteDto getQuote(Long readerId, Long bookId, Long quoteId) {
        Long authenticatedReaderId = SecurityCheck.getAuthenticatedUserId();
    ...
    public List<QuoteDto> getQuotes(Long readerId, Long bookId) {
        Long authenticatedReaderId = SecurityCheck.getAuthenticatedUserId();
